...
namespace RE
{
	namespace Impl
	{
		void CalcCRC32_32(UInt32& a_crc32, UInt32 a_data)
		{
			...
			REL::Offset<func_t> func(Offset::CRC32Calculator::SizeOf32.GetAddress());
			func(a_crc32, a_data);
		}
		...
		void CalcCRC32_64(UInt32& a_crc32, UInt64 a_data)
		{
			...
			REL::Offset<func_t> func(Offset::CRC32Calculator::SizeOf64.GetAddress());
			func(a_crc32, a_data);
		}
		...
		void CalcCRC32_SIZE(UInt32& a_crc32, const void* a_data, UInt32 a_size)
		{
			...
			REL::Offset<func_t> func(Offset::CRC32Calculator::SizeOfSize.GetAddress());
