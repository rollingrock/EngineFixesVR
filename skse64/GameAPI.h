...
public:
	...
	DEFINE_MEMBER_FN(Allocate, void *, 0x00C3D0E0, size_t size, size_t alignment, bool aligned);
	DEFINE_MEMBER_FN(Free, void, 0x00C3D3E0, void * buf, bool aligned);
};
...
public:
	...
	DEFINE_MEMBER_FN(VPrint, void, 0x00886DF0, const char * fmt, va_list args);
