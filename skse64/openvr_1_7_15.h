...
#ifndef _OPENVR_1_7_15_API
#define _OPENVR_1_7_15_API
...
// vrtypes.h
#ifndef _INCLUDE_VRTYPES_1_7_15_H
#define _INCLUDE_VRTYPES_1_7_15_H
...
#define INVALID_SHARED_TEXTURE_HANDLE	((vr_1_7_15::SharedTextureHandle_t)0)
...
#define INVALID_WEB_CONSOLE_HANDLE	((vr_1_7_15::WebConsoleHandle_t)0)
...
{
	vr_1_7_15::PropertyContainerHandle_t ulAppContainer;
...
#define INVALID_TRACKED_CAMERA_HANDLE	((vr_1_7_15::TrackedCameraHandle_t)0)
...
#define VR_COMPOSITOR_ADDITIONAL_PREDICTED_FRAMES( timing ) ( ( ( timing ).m_nReprojectionFlags & vr_1_7_15::VRCompositor_PredictionMask ) >> 4 )
#define VR_COMPOSITOR_NUMBER_OF_THROTTLED_FRAMES( timing ) ( ( ( timing ).m_nReprojectionFlags & vr_1_7_15::VRCompositor_ThrottleMask ) >> 6 )
...
struct Compositor_FrameTiming
{
	...
	* processing that work earlier in the frame. */
	...
	vr_1_7_15::TrackedDevicePose_t m_HmdPose; // pose used by app to render this frame
...
public:
	...
	* in the list, or the size of the array needed if not large enough. */
	virtual uint32_t GetSortedTrackedDeviceIndicesOfClass( ETrackedDeviceClass eTrackedDeviceClass, VR_ARRAY_COUNT(unTrackedDeviceIndexArrayCount) vr_1_7_15::TrackedDeviceIndex_t *punTrackedDeviceIndexArray, uint32_t unTrackedDeviceIndexArrayCount, vr_1_7_15::TrackedDeviceIndex_t unRelativeToTrackedDeviceIndex = k_unTrackedDeviceIndex_Hmd ) = 0;

	/** Returns the level of activity on the device. */
	virtual EDeviceActivityLevel GetTrackedDeviceActivityLevel( vr_1_7_15::TrackedDeviceIndex_t unDeviceId ) = 0;
	...
	*/
	...
	virtual vr_1_7_15::TrackedDeviceIndex_t GetTrackedDeviceIndexForControllerRole( vr_1_7_15::ETrackedControllerRole unDeviceType ) = 0;
	...
	virtual vr_1_7_15::ETrackedControllerRole GetControllerRoleForTrackedDeviceIndex( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex ) = 0;
	...
	* actual tracked device. */
	virtual ETrackedDeviceClass GetTrackedDeviceClass( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex ) = 0;

	/** Returns true if there is a device connected in this slot. */
	virtual bool IsTrackedDeviceConnected( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex ) = 0;

	/** Returns a bool property. If the device index is not valid or the property is not a bool type this function will return false. */
	virtual bool GetBoolTrackedDeviceProperty( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError *pError = 0L ) = 0;

	/** Returns a float property. If the device index is not valid or the property is not a float type this function will return 0. */
	virtual float GetFloatTrackedDeviceProperty( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError *pError = 0L ) = 0;

	/** Returns an int property. If the device index is not valid or the property is not a int type this function will return 0. */
	virtual int32_t GetInt32TrackedDeviceProperty( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError *pError = 0L ) = 0;

	/** Returns a uint64 property. If the device index is not valid or the property is not a uint64 type this function will return 0. */
	virtual uint64_t GetUint64TrackedDeviceProperty( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError *pError = 0L ) = 0;

	/** Returns a matrix property. If the device index is not valid or the property is not a matrix type, this function will return identity. */
	virtual HmdMatrix34_t GetMatrix34TrackedDeviceProperty( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError *pError = 0L ) = 0;
	...
	* greater than the returned size and pBuffer is non-NULL, pBuffer is filled with the contents of array of properties. */
	virtual uint32_t GetArrayTrackedDeviceProperty( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, PropertyTypeTag_t propType, void *pBuffer, uint32_t unBufferSize, ETrackedPropertyError *pError = 0L ) = 0;

	/** Returns a string property. If the device index is not valid or the property is not a string type this function will 
	* return 0. Otherwise it returns the length of the number of bytes necessary to hold this string including the trailing
	* null. Strings will always fit in buffers of k_unMaxPropertyStringSize characters. */
	virtual uint32_t GetStringTrackedDeviceProperty( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, VR_OUT_STRING() char *pchValue, uint32_t unBufferSize, ETrackedPropertyError *pError = 0L ) = 0;
	...
	* This pose will always be older than the call to this function and should not be used to render the device. 
	...
	virtual bool PollNextEventWithPose( ETrackingUniverseOrigin eOrigin, VREvent_t *pEvent, uint32_t uncbVREvent, vr_1_7_15::TrackedDevicePose_t *pTrackedDevicePose ) = 0;
	...
	* is invalid. This function is deprecated in favor of the new IVRInput system. */
	virtual bool GetControllerState( vr_1_7_15::TrackedDeviceIndex_t unControllerDeviceIndex, vr_1_7_15::VRControllerState_t *pControllerState, uint32_t unControllerStateSize ) = 0;
	...
	* pose as input to your application when the user presses or releases a button. This function is deprecated in favor of the new IVRInput system. */
	virtual bool GetControllerStateWithPose( ETrackingUniverseOrigin eOrigin, vr_1_7_15::TrackedDeviceIndex_t unControllerDeviceIndex, vr_1_7_15::VRControllerState_t *pControllerState, uint32_t unControllerStateSize, TrackedDevicePose_t *pTrackedDevicePose ) = 0;

	/** Trigger a single haptic pulse on a controller. After this call the application may not trigger another haptic pulse on this controller
	* and axis combination for 5ms. This function is deprecated in favor of the new IVRInput system. */
	virtual void TriggerHapticPulse( vr_1_7_15::TrackedDeviceIndex_t unControllerDeviceIndex, uint32_t unAxisId, unsigned short usDurationMicroSec ) = 0;
	...
	* its own workload. One common way to do this is to reduce the size of the render target provided for each eye. */
	...
	virtual vr_1_7_15::EVRFirmwareError PerformFirmwareUpdate( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex ) = 0;
...
namespace vr_1_7_15
{
	...
	public:
		...
		*/
		...
		virtual vr_1_7_15::EVRApplicationError LaunchApplicationFromMimeType( const char *pchMimeType, const char *pchArgs ) = 0;
...
public:
	...
	* instead of calling Release on the resource itself. */
	virtual vr_1_7_15::EVRCompositorError GetMirrorTextureD3D11( vr_1_7_15::EVREye eEye, void *pD3D11DeviceOrResource, void **ppD3D11ShaderResourceView ) = 0;
	virtual void ReleaseMirrorTextureD3D11( void *pD3D11ShaderResourceView ) = 0;

	/** Access to mirror textures from OpenGL. */
	virtual vr_1_7_15::EVRCompositorError GetMirrorTextureGL( vr_1_7_15::EVREye eEye, vr_1_7_15::glUInt_t *pglTextureId, vr_1_7_15::glSharedTextureHandle_t *pglSharedTextureHandle ) = 0;
	virtual bool ReleaseSharedGLTexture( vr_1_7_15::glUInt_t glTextureId, vr_1_7_15::glSharedTextureHandle_t glSharedTextureHandle ) = 0;
	virtual void LockGLSharedTextureForAccess( vr_1_7_15::glSharedTextureHandle_t glSharedTextureHandle ) = 0;
	virtual void UnlockGLSharedTextureForAccess( vr_1_7_15::glSharedTextureHandle_t glSharedTextureHandle ) = 0;
...
namespace vr_1_7_15
{
	...
	public:
		...
		* If the texture needs to be resolved, you should call SetOverlayTexture with the appropriate colorspace instead. */
		...
		virtual uint32_t GetOverlayRenderModel( vr_1_7_15::VROverlayHandle_t ulOverlayHandle, VR_OUT_STRING() char *pchValue, uint32_t unBufferSize, HmdColor_t *pColor, vr_1_7_15::EVROverlayError *pError ) = 0;
		...
		virtual vr_1_7_15::EVROverlayError SetOverlayRenderModel( vr_1_7_15::VROverlayHandle_t ulOverlayHandle, const char *pchRenderModel, const HmdColor_t *pColor ) = 0;
		...
		* drawing the device. Overlays with this transform type cannot receive mouse events. */
		...
		virtual vr_1_7_15::EVROverlayError GetOverlayTransformOverlayRelative( VROverlayHandle_t ulOverlayHandle, VROverlayHandle_t *ulOverlayHandleParent, HmdMatrix34_t *pmatParentOverlayToOverlayTransform ) = 0;
		...
		virtual vr_1_7_15::EVROverlayError SetOverlayTransformOverlayRelative( VROverlayHandle_t ulOverlayHandle, VROverlayHandle_t ulOverlayHandleParent, const HmdMatrix34_t *pmatParentOverlayToOverlayTransform ) = 0;
		...
		* by the virtual mouse pointer */
		...
		virtual vr_1_7_15::VROverlayHandle_t GetGamepadFocusOverlay() = 0;
		...
		*/
		...
		virtual vr_1_7_15::TrackedDeviceIndex_t GetPrimaryDashboardDevice() = 0;
...
public:
	...
	* Note: For dynamic objects, visibility may be dynamic. (I.e., true/false will be returned based on controller state and controller mode state ) */
	virtual bool GetComponentStateForDevicePath( const char *pchRenderModelName, const char *pchComponentName, vr_1_7_15::VRInputValueHandle_t devicePath, const vr_1_7_15::RenderModel_ControllerMode_State_t *pState, vr_1_7_15::RenderModel_ComponentState_t *pComponentState ) = 0;
	...
	virtual bool GetComponentState( const char *pchRenderModelName, const char *pchComponentName, const vr_1_7_15::VRControllerState_t *pControllerState, const RenderModel_ControllerMode_State_t *pState, RenderModel_ComponentState_t *pComponentState ) = 0;
	...
	virtual uint32_t GetRenderModelThumbnailURL( const char *pchRenderModelName, VR_OUT_STRING() char *pchThumbnailURL, uint32_t unThumbnailURLLen, vr_1_7_15::EVRRenderModelError *peError ) = 0;
	...
	* model. */
	virtual uint32_t GetRenderModelOriginalPath( const char *pchRenderModelName, VR_OUT_STRING() char *pchOriginalPath, uint32_t unOriginalPathLen, vr_1_7_15::EVRRenderModelError *peError ) = 0;

	/** Returns a string for a render model error */
	virtual const char *GetRenderModelErrorNameFromEnum( vr_1_7_15::EVRRenderModelError error ) = 0;
};
...
public:
	...
	virtual const char *GetCameraErrorNameFromEnum( vr_1_7_15::EVRTrackedCameraError eCameraError ) = 0;

	/** For convenience, same as tracked property request Prop_HasCamera_Bool */
	virtual vr_1_7_15::EVRTrackedCameraError HasCamera( vr_1_7_15::TrackedDeviceIndex_t nDeviceIndex, bool *pHasCamera ) = 0;

	/** Gets size of the image frame. */
	virtual vr_1_7_15::EVRTrackedCameraError GetCameraFrameSize( vr_1_7_15::TrackedDeviceIndex_t nDeviceIndex, vr_1_7_15::EVRTrackedCameraFrameType eFrameType, uint32_t *pnWidth, uint32_t *pnHeight, uint32_t *pnFrameBufferSize ) = 0;

	virtual vr_1_7_15::EVRTrackedCameraError GetCameraIntrinsics( vr_1_7_15::TrackedDeviceIndex_t nDeviceIndex, uint32_t nCameraIndex, vr_1_7_15::EVRTrackedCameraFrameType eFrameType, vr_1_7_15::HmdVector2_t *pFocalLength, vr_1_7_15::HmdVector2_t *pCenter ) = 0;

	virtual vr_1_7_15::EVRTrackedCameraError GetCameraProjection( vr_1_7_15::TrackedDeviceIndex_t nDeviceIndex, uint32_t nCameraIndex, vr_1_7_15::EVRTrackedCameraFrameType eFrameType, float flZNear, float flZFar, vr_1_7_15::HmdMatrix44_t *pProjection ) = 0;
	...
	* The camera may go inactive due to lack of active consumers or headset idleness. */
	virtual vr_1_7_15::EVRTrackedCameraError AcquireVideoStreamingService( vr_1_7_15::TrackedDeviceIndex_t nDeviceIndex, vr_1_7_15::TrackedCameraHandle_t *pHandle ) = 0;
	virtual vr_1_7_15::EVRTrackedCameraError ReleaseVideoStreamingService( vr_1_7_15::TrackedCameraHandle_t hTrackedCamera ) = 0;
	...
	* Ideally a caller should be polling at ~16ms intervals */
	virtual vr_1_7_15::EVRTrackedCameraError GetVideoStreamFrameBuffer( vr_1_7_15::TrackedCameraHandle_t hTrackedCamera, vr_1_7_15::EVRTrackedCameraFrameType eFrameType, void *pFrameBuffer, uint32_t nFrameBufferSize, vr_1_7_15::CameraVideoStreamFrameHeader_t *pFrameHeader, uint32_t nFrameHeaderSize ) = 0;

	/** Gets size of the image frame. */
	virtual vr_1_7_15::EVRTrackedCameraError GetVideoStreamTextureSize( vr_1_7_15::TrackedDeviceIndex_t nDeviceIndex, vr_1_7_15::EVRTrackedCameraFrameType eFrameType, vr_1_7_15::VRTextureBounds_t *pTextureBounds, uint32_t *pnWidth, uint32_t *pnHeight ) = 0; 
	...
	* guarantees a rectangle where all pixels are valid. */
	virtual vr_1_7_15::EVRTrackedCameraError GetVideoStreamTextureD3D11( vr_1_7_15::TrackedCameraHandle_t hTrackedCamera, vr_1_7_15::EVRTrackedCameraFrameType eFrameType, void *pD3D11DeviceOrResource, void **ppD3D11ShaderResourceView, vr_1_7_15::CameraVideoStreamFrameHeader_t *pFrameHeader, uint32_t nFrameHeaderSize ) = 0;

	/** Access a shared GL texture for the specified tracked camera stream */
	virtual vr_1_7_15::EVRTrackedCameraError GetVideoStreamTextureGL( vr_1_7_15::TrackedCameraHandle_t hTrackedCamera, vr_1_7_15::EVRTrackedCameraFrameType eFrameType, vr_1_7_15::glUInt_t *pglTextureId, vr_1_7_15::CameraVideoStreamFrameHeader_t *pFrameHeader, uint32_t nFrameHeaderSize ) = 0;
	virtual vr_1_7_15::EVRTrackedCameraError ReleaseVideoStreamTextureGL( vr_1_7_15::TrackedCameraHandle_t hTrackedCamera, vr_1_7_15::glUInt_t glTextureId ) = 0;
	virtual void SetCameraTrackingSpace( vr_1_7_15::ETrackingUniverseOrigin eUniverse ) = 0;
	virtual vr_1_7_15::ETrackingUniverseOrigin GetCameraTrackingSpace( ) = 0;
};
...
public:
	...
	virtual vr_1_7_15::EVRScreenshotError RequestScreenshot( vr_1_7_15::ScreenshotHandle_t *pOutScreenshotHandle, vr_1_7_15::EVRScreenshotType type, const char *pchPreviewFilename, const char *pchVRFilename ) = 0;
	...
	virtual vr_1_7_15::EVRScreenshotError HookScreenshot( VR_ARRAY_COUNT( numTypes ) const vr_1_7_15::EVRScreenshotType *pSupportedTypes, int numTypes ) = 0;
	...
	virtual vr_1_7_15::EVRScreenshotType GetScreenshotPropertyType( vr_1_7_15::ScreenshotHandle_t screenshotHandle, vr_1_7_15::EVRScreenshotError *pError ) = 0;

	/** Get the filename for the preview or vr image (see
	 *  vr::EScreenshotPropertyFilenames).  The return value is
	 *  the size of the string.   */
 	virtual uint32_t GetScreenshotPropertyFilename( vr_1_7_15::ScreenshotHandle_t screenshotHandle, vr_1_7_15::EVRScreenshotPropertyFilenames filenameType, VR_OUT_STRING() char *pchFilename, uint32_t cchFilename, vr_1_7_15::EVRScreenshotError *pError ) = 0;
	 ...
	 *  bar. */
	virtual vr_1_7_15::EVRScreenshotError UpdateScreenshotProgress( vr_1_7_15::ScreenshotHandle_t screenshotHandle, float flProgress ) = 0;
	...
	virtual vr_1_7_15::EVRScreenshotError TakeStereoScreenshot( vr_1_7_15::ScreenshotHandle_t *pOutScreenshotHandle, const char *pchPreviewFilename, const char *pchVRFilename ) = 0;
	...
	virtual vr_1_7_15::EVRScreenshotError SubmitScreenshot( vr_1_7_15::ScreenshotHandle_t screenshotHandle, vr_1_7_15::EVRScreenshotType type, const char *pchSourcePreviewFilename, const char *pchSourceVRFilename ) = 0;
};
...
public:
	...
	virtual uint32_t GetDriverName( vr_1_7_15::DriverId_t nDriver, VR_OUT_STRING() char *pchValue, uint32_t unBufferSize ) = 0;

	virtual DriverHandle_t GetDriverHandle( const char *pchDriverName ) = 0;

	virtual bool IsEnabled( vr_1_7_15::DriverId_t nDriver ) const = 0;
};
...
static const uint64_t k_ulInvalidIOBufferHandle = 0;
	...
	public:
		...
		virtual vr_1_7_15::EIOBufferError Open( const char *pchPath, vr_1_7_15::EIOBufferMode mode, uint32_t unElementSize, uint32_t unElements, vr_1_7_15::IOBufferHandle_t *pulBuffer ) = 0;
		
		/** closes a previously opened or created buffer */
		virtual vr_1_7_15::EIOBufferError Close( vr_1_7_15::IOBufferHandle_t ulBuffer ) = 0;
		
		/** reads up to unBytes from buffer into *pDst, returning number of bytes read in *punRead */
		virtual vr_1_7_15::EIOBufferError Read( vr_1_7_15::IOBufferHandle_t ulBuffer, void *pDst, uint32_t unBytes, uint32_t *punRead ) = 0;
		
		/** writes unBytes of data from *pSrc into a buffer. */
		virtual vr_1_7_15::EIOBufferError Write( vr_1_7_15::IOBufferHandle_t ulBuffer, void *pSrc, uint32_t unBytes ) = 0;
		
		/** retrieves the property container of an buffer. */
		virtual vr_1_7_15::PropertyContainerHandle_t PropertyContainer( vr_1_7_15::IOBufferHandle_t ulBuffer ) = 0;

		/** inexpensively checks for readers to allow writers to fast-fail potentially expensive copies and writes. */
		virtual bool HasReaders( vr_1_7_15::IOBufferHandle_t ulBuffer ) = 0;
	};
...
namespace vr_1_7_15
{
	...
	public:
		...
		* The size of the response including its terminating null is returned. */
		virtual uint32_t DriverDebugRequest( vr_1_7_15::TrackedDeviceIndex_t unDeviceIndex, const char *pchRequest, VR_OUT_STRING() char *pchResponseBuffer, uint32_t unResponseBufferSize ) = 0;
